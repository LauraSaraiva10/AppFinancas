...
function handleDelete(data){
  ...
  const dateHoje = new Date(`${anoItem}/${mesItem}/${diaItem}`);
  console.log(dateHoje);

  if( isBefore(dateItem, dateHoje) ){
     //se o dateItem for anterior ao dateHoje
    alert('Não pode remover um registo antigo!');
    return;
  }

  Alert.alert(
    'Cuidado Atenção!',
    `Deseja exluir ${data.tipo} - Valor: ${data.valor} ?`,
    [
      {
        text: 'Cancelar',
        style: 'cancel'
